import { FederationConfig } from '../types/index.js';

export const defaultConfig: FederationConfig = {
...
export const config: FederationConfig = {
...
export function validateConfig(config: FederationConfig): void {
