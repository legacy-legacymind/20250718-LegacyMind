#!/usr/bin/env python3
"""
Convert string-stored thoughts to ReJSON format in Redis (non-interactive version).
"""
...
def main():
    print("Starting automatic conversion of string thoughts to ReJSON format...")
        ...
        for key in keys:
            ...
            if key_type == 'string':
                ...
                if success:
                    converted += 1
                    if converted % 50 == 0:
                        print(f"Progress: Converted {converted} thoughts...")
                else:
                    errors += 1
